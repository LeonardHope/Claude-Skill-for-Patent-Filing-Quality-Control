...
class PatentFilingQC:
    ...
    def extract_docket_number(self, text: str) -> str:
        ...
        # Docket numbers typically look like: X000-0000US, 12345-001, ABC-123-US, etc.
        patterns = [
            # "Attorney Docket No.: X000-0000US" or "Docket No.: X000-0000US"
    ...
    def check_file_quality(self):
        ...
        naming_issues = []
        docket_pattern = r'A\d{3}-\d{4}'  # e.g., X000-0000US
